...
| **Game Rules & Mechanics** | d20 Checks, DCs, Threat Clock (0–6), Combat, 3-Stage Social, 3-Clue Rule | [docs/game_design/GAME_RULES_AND_MECHANICS.md](./docs/game_design/GAME_RULES_AND_MECHANICS.md) |
...
1. **Physical-First, Digital-Ambient**: Players roll real d20s, touch real cards, and look at each other across a physical battlemap.
